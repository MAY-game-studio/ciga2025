...
public class LoadingUI : UIPrefabBase
{
    ...
    private readonly string[] _loadingTexts = {"Loading", "Loading.", "Loading..", "Loading..."}; //预存的loading文字
    ...
    {
        if (_textAnim == null) return;
        StopCoroutine(_textAnim);
        _textAnim = null;
    }

    private IEnumerator LoadingTextAnim() //更新loading文字直至销毁
    {
        int num = 0;
        while (true)
        {
